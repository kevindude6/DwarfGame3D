...
namespace BradGame3D.Entities.Flora
{
    public class Tree : Plant
    {
        ...
        public static float texHeight = (float) (192.0/1024.0);
        ...
        public Tree(ref Chunk c, int seed, Vector3 pos): base(ref c, seed, pos)
        {
        }
        ...
        public override void genFromSeed()
        {
            ...
            height = RandomFunctions.Normal(r, 1f, 6); //6
            width = RandomFunctions.Normal(r, 0.33f, 4); //3
            length = width;
        }
    }
}
